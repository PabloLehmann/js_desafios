...
const actualizarCarrito = () => {
    ...
    contadorCarrito3.innerText = carritoVarios.reduce((acc, prod) => acc += prod.kilos, 0)
    precioTotal3.innerText = carritoVarios.reduce((acc, prod) => acc += prod.precio * prod.kilos, 0)
